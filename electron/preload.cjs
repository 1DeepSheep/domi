...
contextBridge.exposeInMainWorld("workbench", {
  ...
  testCodexConnection: (request) => ipcRenderer.invoke("settings:test-codex", request),
  cancelCodexConnectionTest: (request) => ipcRenderer.invoke("settings:cancel-codex-test", request),
  ...
  recoverCodexThread: (threadId, request) => ipcRenderer.invoke("codex:recover-thread", threadId, request),
  ...
  refreshIndustryOverviews: (request) => ipcRenderer.invoke("domi:industry-overviews", request),
  ...
  preparePlaudContext: (request) => ipcRenderer.invoke("domi:plaud-context-prepare", request),
  savePlaudContext: (request) => ipcRenderer.invoke("domi:plaud-context-submit", request),
  savePlaudContextDraft: (request) => ipcRenderer.invoke("domi:plaud-context-draft", request),
  summarizePlaudContext: (request) => ipcRenderer.invoke("domi:plaud-context-recall", request),
