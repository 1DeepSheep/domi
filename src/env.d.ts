...
export type IndustryOverviewResult = { ok: boolean; entries: IndustryOverviewEntry[]; indexPath?: string; projectCount?: number; news?: DomiNewsItem[]; cached?: boolean; conflicts?: unknown[]; warnings?: unknown[]; error?: string };
