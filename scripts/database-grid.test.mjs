...
const rows = [
  { name: "示例芯片", rating: "A", system: "2026-08-07" },
  { name: "示例数据科技", rating: "S", system: "2026-08-06" },
  { name: "ExampleTrust AI", rating: "B", system: "2026-08-05" }
];
