...
assert.doesNotMatch(afterPackSource, /["']-cr["']/);
assert.match(afterPackSource, /com\.apple\.FinderInfo/);
assert.match(afterPackSource, /com\.apple\.ResourceFork/);
require("./after-pack.test.cjs");
